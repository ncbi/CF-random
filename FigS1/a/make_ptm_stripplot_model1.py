...
if __name__ == '__main__':
    ...
    f3 = open('RfaH_colabfold_msax250_model1_ptm_plddts_sorted.txt').read().splitlines()
    ...
    #dict_info = {'Whole MSA': nums3, 'AF-cluster':nums2}
    ...
    #plt.plot([0.85,1.15],[73.9,73.9],'r-',zorder=10)
    ...
    plt.savefig('ptm_comparison_model1.png',dpi=1200)
